...
print('общее время звучания трех песен', song_1 + song_2 + song_3)
...
song_1 = violator_songs_dict['Sweetest Perfection']
song_2 = violator_songs_dict['Policy of Truth']
song_3 = violator_songs_dict['Blue Dress']
print('общее время звучания трех песен', song_1 + song_2 + song_3)
